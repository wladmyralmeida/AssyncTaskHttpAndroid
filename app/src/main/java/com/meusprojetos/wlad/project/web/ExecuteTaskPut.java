...
public class ExecuteTaskPut extends AsyncTask<Imovel, Void, Imovel> {
    ...
    public ExecuteTaskPut(MainActivity activity) {
    ...
    protected Imovel doInBackground(Imovel... imoveis) {
        ...
        try {
            ...
            parametros.put("idImovel", String.valueOf(imovel.getIdImovel()));
